...
#define CAPTURE_FRAME_SIZE_FILTER_ON FRAMESIZE_QVGA
#define CAPTURE_FRAME_SIZE_FILTER_OFF FRAMESIZE_VGA
#define CAPTURE_FB_COUNT 2
#define CAPTURE_WARMUP_FRAMES 1
#define CAPTURE_WARMUP_DELAY_MS 12
#define JPG_ENCODE_QUALITY 100
#define CAPTURE_SENSOR_JPEG_QUALITY 5 // OV2640 hardware JPEG quality (0-63, lower=better)
